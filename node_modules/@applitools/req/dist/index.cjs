...
var require_utility_types = __commonJS({
  "node_modules/@applitools/utils/dist/utility-types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var require_types = __commonJS({
  "node_modules/@applitools/utils/dist/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_guard = __commonJS({
  "node_modules/@applitools/utils/dist/guard.js"(exports) {
    "use strict";
    ...
    function isString(value, { name, strict = true, alpha, numeric }) {
      if ((strict || !types5.isNull(value)) && !types5.isString(value)) {
    ...
    function isEnumValue(value, enumeration, { name, strict = true }) {
      const values = new Set(Object.values(enumeration));
      if ((strict || !types5.isNull(value)) && !values.has(value)) {
    ...
    function isOneOf(value, values, { name, strict = true }) {
      if ((strict || !types5.isNull(value)) && !values.includes(value)) {
...
var require_general = __commonJS({
  "node_modules/@applitools/utils/dist/general.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function sleep(ms) {
      if (types5.isNumber(ms)) {
        return new Promise((resolve) => setTimeout(resolve, ms));
      }
    }
    exports.sleep = sleep;
    function toJSON(object, props) {
      if (!types5.isObject(object))
        return object;
      if (types5.isArray(object)) {
        return object.map((value) => value && types5.isFunction(value.toJSON) ? value.toJSON() : toJSON(value));
      }
      const original = props ? Object.values(props) : Object.keys(object);
      const keys = !props || types5.isArray(props) ? original : Object.keys(props);
      return keys.reduce((plain, key, index) => {
        const value = object[original[index]];
        plain[key] = value && types5.isFunction(value.toJSON) ? value.toJSON() : toJSON(value);
        return plain;
      }, {});
    }
    ...
    function cachify(func, getKey) {
      ...
      function stringifyKey(key) {
        key = types5.isPlainObject(key) ? Object.fromEntries(Object.entries(key).sort(([key1], [key2]) => key1 > key2 ? 1 : -1)) : key;
    ...
    function extend(target, extension) {
      ...
      return Object.defineProperties(result, {
        ...
        ...Object.getOwnPropertyDescriptors(types5.isFunction(extension) ? extension(result) : extension)
      });
    }
    exports.extend = extend;
    function pluralize(object, config) {
      const count = types5.isArray(object) ? object.length : object;
...
var require_geometry = __commonJS({
  "node_modules/@applitools/utils/dist/geometry.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function round(target) {
      const result = { ...target };
      if (types5.has(target, ["x", "y"])) {
        result.x = Math.round(target.x);
        result.y = Math.round(target.y);
      }
      if (types5.has(target, ["width", "height"])) {
    ...
    function floor(target) {
      ...
      if (types5.has(target, ["width", "height"])) {
        result.width = Math.floor(target.width + (types5.has(target, "x") ? target.x - result.x : 0));
        result.height = Math.floor(target.height + (types5.has(target, "y") ? target.y - result.y : 0));
      }
      return result;
    }
    exports.floor = floor;
    function rotate(target, degrees, size2) {
      ...
      if (types5.has(target, ["x", "y"]) && size2) {
        const hasSize = types5.has(target, ["width", "height"]);
        if (degrees === 0) {
          result.x = target.x;
          result.y = target.y;
        } else if (degrees === 90) {
    ...
    function contains(region2, locationOrRegion) {
      if (region2.x <= locationOrRegion.x && region2.y <= locationOrRegion.y) {
        if (types5.has(locationOrRegion, ["width", "height"])) {
    ...
    function equals(locationOrSizeOrRegion1, locationOrSizeOrRegion2) {
      if (types5.has(locationOrSizeOrRegion1, ["x", "y", "width", "height"])) {
        if (types5.has(locationOrSizeOrRegion2, ["x", "y", "width", "height"])) {
      ...
      if (types5.has(locationOrSizeOrRegion1, ["x", "y"])) {
        if (types5.has(locationOrSizeOrRegion2, ["x", "y"])) {
          return locationOrSizeOrRegion1.x === locationOrSizeOrRegion2.x && locationOrSizeOrRegion1.y === locationOrSizeOrRegion2.y;
        }
        return false;
      }
      if (types5.has(locationOrSizeOrRegion1, ["width", "height"])) {
        if (types5.has(locationOrSizeOrRegion2, ["width", "height"])) {
...
// node_modules/@applitools/utils/dist/promises.js
var require_promises = __commonJS({
  "node_modules/@applitools/utils/dist/promises.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_math = __commonJS({
  "node_modules/@applitools/utils/dist/math.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@applitools/utils/dist/streams.js
var require_streams2 = __commonJS({
  "node_modules/@applitools/utils/dist/streams.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
// node_modules/@applitools/utils/dist/process.js
var require_process = __commonJS({
  "node_modules/@applitools/utils/dist/process.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@applitools/utils/dist/config.js
var require_config = __commonJS({
  "node_modules/@applitools/utils/dist/config.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_dist4 = __commonJS({
  "node_modules/@applitools/utils/dist/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var utils = __toESM(require_dist4(), 1);
function makeProxyAgent(proxy) {
  return function agent(url) {
    ...
    if (proxyOptions) {
      ...
      const options = { ...(0, import_url.parse)(proxyUrl.href), rejectUnauthorized: false };
      if (url.protocol === "https:") {
        const agent2 = (0, import_https_proxy_agent.default)(options);
        agent2.callback = utils.general.wrap(agent2.callback.bind(agent2), (fn, request, options2, ...rest) => {
...
// dist/req.js
var utils2 = __toESM(require_dist4(), 1);
...
async function req(input, ...requestOptions) {
  ...
  const fetch2 = (_a4 = options === null || options === void 0 ? void 0 : options.fetch) !== null && _a4 !== void 0 ? _a4 : fetch;
  if (options === null || options === void 0 ? void 0 : options.hooks)
    options.hooks = utils2.types.isArray(options.hooks) ? options.hooks : [options.hooks];
  if (options === null || options === void 0 ? void 0 : options.retry)
    options.retry = utils2.types.isArray(options.retry) ? options.retry : [options.retry];
  if (options === null || options === void 0 ? void 0 : options.headers) {
    options.headers = Object.fromEntries(Object.entries(options.headers).filter(([_, value]) => value));
  }
  const controller = new import_abort_controller.AbortController();
  ...
  let request = new Request(url, {
    ...
    headers: {
      ...Object.fromEntries((_e = (_d2 = input.headers) === null || _d2 === void 0 ? void 0 : _d2.entries()) !== null && _e !== void 0 ? _e : []),
      ...Object.fromEntries(new Headers(options === null || options === void 0 ? void 0 : options.headers).entries())
    },
    body: utils2.types.isPlainObject(options === null || options === void 0 ? void 0 : options.body) || utils2.types.isArray(options === null || options === void 0 ? void 0 : options.body) || (options === null || options === void 0 ? void 0 : options.body) === null ? JSON.stringify(options === null || options === void 0 ? void 0 : options.body) : (_f = options === null || options === void 0 ? void 0 : options.body) !== null && _f !== void 0 ? _f : input.body,
  ...
  try {
    ...
    const retry = await ((_g = options === null || options === void 0 ? void 0 : options.retry) === null || _g === void 0 ? void 0 : _g.reduce(async (prev, retry2) => {
      var _a5, _b2;
    ...
    if (retry) {
      ...
      const delay = response.headers.has("Retry-After") ? Number(response.headers.get("Retry-After")) * 1e3 : utils2.types.isArray(retry.timeout) ? retry.timeout[Math.min(retry.attempt, retry.timeout.length - 1)] : (_j = retry.timeout) !== null && _j !== void 0 ? _j : 0;
      await utils2.general.sleep(delay);
      retry.attempt += 1;
    ...
    const retry = await ((_k = options === null || options === void 0 ? void 0 : options.retry) === null || _k === void 0 ? void 0 : _k.reduce((prev, retry2) => {
    ...
    if (retry) {
      ...
      const delay = utils2.types.isArray(retry.timeout) ? retry.timeout[Math.min(retry.attempt, retry.timeout.length)] : (_m = retry.timeout) !== null && _m !== void 0 ? _m : 0;
      await utils2.general.sleep(delay);
...
function beforeRequest({ request, options, ...rest }) {
  ...
  return ((_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []).reduce(async (request2, hooks) => {
    ...
    if (!result)
      return request2;
    else if (utils2.types.instanceOf(result, Request))
      return result;
    else if (utils2.types.has(result, "url"))
...
function afterResponse({ response, options, ...rest }) {
  ...
  return (_b = (_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []) === null || _b === void 0 ? void 0 : _b.reduce(async (response2, hooks) => {
    ...
    if (!result)
      return response2;
    else if (utils2.types.instanceOf(result, Response))
      return result;
    else
...
function afterError({ error, options, ...rest }) {
  ...
  return (_b = (_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []) === null || _b === void 0 ? void 0 : _b.reduce(async (error2, hooks) => {
    var _a5;
    error2 = await error2;
    return await ((_a5 = hooks.afterError) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { error: error2, ...rest })) || error2;
  }, error);
}
